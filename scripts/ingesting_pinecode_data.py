"""
This script is used to ingest the data into the Pinecone vector database.
"""
...
## Importing the necessary modules from the langchain library
...
# Hash cache is needed to avoid ingesting the same data multiple times and also improving the freshness of the data.
hash_cache = {}
...
for file_name, file_path in current_files.items():
    ...
    try:
        ...
        # helps to avoid the API rate limit error     
        batch_size = 100
