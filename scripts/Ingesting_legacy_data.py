...
# Climbing up 1 levels to project root
...
# Mapping clean columns to a messy 2000s legacy enterprise schema
legacy_mapping = {
    'timestamp': 'TS_UTC',
...
# Keeping only the columns we mapped for this demo and renaming them
...
# Connecting to Docker MSSQL Server
...
# Ingesting data into the messy table name
